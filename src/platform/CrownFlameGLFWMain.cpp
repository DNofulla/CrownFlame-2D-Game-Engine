...
#pragma region window and opengl
	...
	permaAssertComment(glfwInit(), "GLFW ERROR: Failed to Initialize GLFW!");
	...
	int w = 500;
	int h = 500;
	wind = glfwCreateWindow(w, h, "CrownFlame 2D Game Engine", nullptr, nullptr);
	...
	permaAssertComment(gladLoadGLLoader((GLADloadproc)glfwGetProcAddress), "GLAD ERROR: Failed to Initialize GLAD!");
